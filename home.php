...
<head>
	...
	<style>
		...
		p.p-centre { text-align: center; font-family: Arial; color:white; }
...
<body>
	...
	<p class="p-centre">Choose one of the navigation tabs to book your tickets or find out whats on.</p>
